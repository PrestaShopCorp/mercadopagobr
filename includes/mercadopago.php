...
class MP_SDK
{
    ...
    {
        $access_token = $this->getAccessToken();
        $trackingID = "platform:desktop,type:prestashop,so:".MP_SDK::VERSION;
    ...
    {
        $access_token = $this->getAccessTokenV1();
        $trackingID = "platform:v1-whitelabel,type:prestashop,so:".MP_SDK::VERSION;
    ...
    private static function setData($connect, $data, $content_type)
    {
        if ($content_type == 'application/json') {
            ...
            if (function_exists('json_last_error')) {
                ...
                error_log(Tools::jsonEncode("======json_error=====".$json_error));
