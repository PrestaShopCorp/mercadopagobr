    ...
    private function placeOrder() {
       // card_token_id
        ...
        if ($order_status != null) {
            ...
            $this->context->controller->addCss ( (Configuration::get ( 'PS_SSL_ENABLED' ) ? 'https://' : 'http://') . htmlspecialchars ( $_SERVER ['HTTP_HOST'], ENT_COMPAT, 'UTF-8' ) . __PS_BASE_URI__ . 'modules/mercadopagobr/views/css/mercadopago_core.css', 'all' );
