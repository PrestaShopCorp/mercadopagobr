		...
		<form action="{$this_path_ssl|escape:'htmlall'}index.php?fc=module&module=mercadopago&controller=custompayment" method="post" id="form-pagar-mp">
	    	<div class="row">
		    	...
		    	<div class="col col-expiration">
			    	<label for="id-card-expiration-month">{l s='Validade Mês: ' mod='mercadopago'}</label>
			    ...
			    <div class="col col-expiration">
			    	<label for="id-card-expiration-month">{l s='Validade Ano: ' mod='mercadopago'}</label>
...
{elseif $creditcard_active == 'true' && $public_key == ''}
	<div class="error">
		{l s='O checkout do cartão de crédito transparente está com a public key inválida. Altere sua public key em Configurações de administrador->Módulos->Pagamentos->MercadoPago.' mod='mercadopago'}
	</div>
</div>
{/if}
...
<div class="payment_module mp-form"> 
	<div class="row" style="margin-bottom: 40px">
		<div class="row boleto" style="background: url({$this_path_ssl|escape:'htmlall'}modules/mercadopago/views/img/boleto.png) 77% no-repeat;">
			<div class="col">
				<span class="payment-label"> {l s='BOLETO' mod='mercadopago'} </span></br>
				<span class="poweredby"> Powered by </span>
				<img class="logo" src="{$this_path_ssl|escape:'htmlall'}modules/mercadopago/views/img/payment_method_logo.png">
			</div>
			<a href="javascript:void(0);" id="id-boleto">Pague com boleto via MercadoPago
...
<div class="payment_module mp-form" style="margin-bottom: 40px"> 
	<div style="margin-bottom: 40px">
		...
		<a class="standard" href="{$this_path_ssl|escape:'htmlall'}index.php?fc=module&module=mercadopago&controller=standardcheckout" id="id-standard"> {l s='Pague via MercadoPago e parcele em' mod='mercadopago'}</br>{l s='até 24 vezes' mod='mercadopago'}</a>
